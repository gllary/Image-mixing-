...
def main():
    ...
    plt.imsave(os.path.join(main_path, 'results/test1218', 'blur_image.png'), normalize(blur_image + 0.5), dpi=95)
    ...
    plt.imsave(os.path.join(main_path, 'results/test1218', 'large_blur_image.png'), normalize(large_blur_image + 0.5), dpi=95)
    ...
    plt.imsave(os.path.join(main_path, 'results/test1218', 'sobel_image.png'), normalize(sobel_image + 0.5), dpi=95)
    ...
    plt.imsave(os.path.join(main_path, 'results/test1218', 'laplacian_image.png'), normalize(laplacian_image + 0.5), dpi=95)
    ...
    plt.imsave(os.path.join(main_path, 'results/test1218', 'high_pass_image.png'), normalize(high_pass_image + 0.5), dpi=95)
    plt.show()
